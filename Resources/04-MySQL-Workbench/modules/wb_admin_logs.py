...
import mforms
from wb_admin_utils import not_running_warning_label, not_running_warning_label_text, make_panel_header
...
class LogView(mforms.Box):
    ...
    def update_ui(self):
        ...
        try:
            ...
            log_error(_this_file, "Exception creating log reader: %s\n" % error)
